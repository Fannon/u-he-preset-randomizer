  ...
  for (let i = 0; i < number; i++) {
    ...
    (randomPreset.meta = [
      ...
      },
      {
        key: "Description",
        value:
          "Fully random preset, generated by https://github.com/Fannon/u-he-preset-randomizer",
      },
    ]),
...
export function generateMergedPresets(
  ...
  for (let i = 0; i < config.amount; i++) {
    const newPreset: Preset = JSON.parse(
    ...
    (newPreset.meta = [
      ...
      },
      {
        ...
        value: `Merged preset, based on ${mergePresets
          ...
          .join(
            ", "
          )}. Generated by https://github.com/Fannon/u-he-preset-randomizer`,
      },
    ]),
